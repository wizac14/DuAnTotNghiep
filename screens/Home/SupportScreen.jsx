...
const SupportScreen = () => {
    ...
    return (
        <SafeAreaView style={styles.contrainer}>
            ...
            <ScrollView>
                <TouchableOpacity style={{ flexDirection: "row", margin: 10, backgroundColor: "#F8F8FF", borderRadius: 10, height: 60 }} onPress={sendMessage}>
                    <Icon
                ...
                <TouchableOpacity style={{ flexDirection: "row", margin: 10, backgroundColor: "#F8F8FF", borderRadius: 10, height: 60 }} onPress={() => Linking.openURL('sms:App bán giày')}>
                    <Ionicons name="chatbox" size={30} />
                    <Text style={styles.text} >Liên hệ qua SMS</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{ flexDirection: "row", margin: 10, backgroundColor: "#F8F8FF", borderRadius: 10, height: 60 }} onPress={() => Linking.openURL('tel:0899865329')}>
                    <Ionicons name="phone-portrait-sharp" size={30} />
                    <Text style={styles.text} >Liên hệ qua Điện thoại</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{ flexDirection: "row", margin: 10, backgroundColor: "#F8F8FF", borderRadius: 10, height: 60 }} onPress={() => Linking.openURL('mailto:hoacrkh10@gmail.com')}>
                    <Ionicons name="mail-unread-outline" size={30} color="red" />
                    <Text style={styles.text} >Liên hệ qua Gmail</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={{ flexDirection: "row", margin: 10, backgroundColor: "#F8F8FF", borderRadius: 10, height: 60 }}
